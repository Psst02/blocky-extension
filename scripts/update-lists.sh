...
curl -L https://raw.githubusercontent.com/Spam404/lists/master/main-blacklist.txt -o data/blacklist.txt
...
npx @eyeo/abp2dnr < data/blacklist.txt > src/rulesets/redirects.json
